package com.debuggeandoideas.companies_crud.config;
...
public class ObserverBeans {
    ...
    public SdkLoggerProvider sdkLoggerProvider(Environment env, ObjectProvider<LogRecordProcessor> processor){
        var aaplicationName = env.getProperty("spring.application.name:", "application");
        var springResource = Resource.create(Attributes.of(ResourceAttributes.SERVICE_NAME, aaplicationName));
